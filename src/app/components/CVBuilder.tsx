  ...
  return (
    <div className="min-h-screen bg-[#070D1A] flex flex-col">
      ...
      <div className="flex-1 flex overflow-hidden" style={{ maxHeight: 'calc(100vh - 64px)' }}>
        <div className="hidden lg:block w-56 flex-shrink-0 border-r border-white/[0.06] overflow-y-auto bg-[#070D1A]">
          <SectionNav
        ...
        <aside className="hidden lg:flex w-[340px] flex-shrink-0 border-l border-white/[0.06] overflow-y-auto flex-col gap-0 bg-[#070D1A]">
      ...
      <div className="lg:hidden fixed bottom-6 right-6 z-40 flex flex-col gap-3">
        <motion.button
          onClick={() => {
            setMobileSectionsOpen(true);
            setMobileCoachOpen(false);
          }}
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          className="w-12 h-12 rounded-full bg-gradient-to-br from-[#1E3A8A] to-[#1E3A8A]/90 text-white flex items-center justify-center shadow-lg shadow-black/40 border border-white/10"
        >
        ...
        <motion.button
          onClick={() => {
            setMobileCoachOpen(true);
            setMobileSectionsOpen(false);
          }}
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          className="relative w-12 h-12 rounded-full bg-gradient-to-br from-[#22C55E] to-[#22C55E]/90 text-white flex items-center justify-center shadow-lg shadow-black/40 border border-white/10"
        >
          <Brain className="w-5 h-5" />
          <span className="absolute -top-1 -right-1 w-3 h-3 bg-[#22C55E] rounded-full border border-[#070D1A] animate-ping" />
        </motion.button>
      </div>

      {/* Mobile Drawers (AnimatePresence Overlay Trays) */}
      <AnimatePresence>
        {mobileSectionsOpen && (
          <>
            <motion.div
            ...
            <motion.div
              ...
              className="lg:hidden fixed top-0 left-0 bottom-0 w-72 bg-[#070D1A] z-50 border-r border-white/10 shadow-2xl flex flex-col pt-16"
            >
              <div className="flex items-center justify-between px-4 py-3 border-b border-white/5 bg-[#070D1A]">
                <span className="text-white font-bold text-sm">Sections</span>
                <button
                  onClick={() => setMobileSectionsOpen(false)}
        ...
        {mobileCoachOpen && (
          <>
            ...
            <motion.div
              ...
              exit={{ x: '100%' }}
              transition={{ type: 'spring', damping: 26, stiffness: 220 }}
              className="lg:hidden fixed top-0 right-0 bottom-0 w-[320px] bg-[#070D1A] z-50 border-l border-white/10 shadow-2xl flex flex-col pt-16"
            >
              <div className="flex items-center justify-between px-4 py-3 border-b border-white/5 bg-[#070D1A]">
                <div className="flex items-center gap-2">
                  <Brain className="w-4 h-4 text-[#22C55E]" />
                  <span className="text-white font-bold text-sm">AI Coach & Insights</span>
                </div>
                <button
                  onClick={() => setMobileCoachOpen(false)}
                  className="p-1 rounded-lg text-gray-400 hover:text-white"
              ...
              <div className="flex-1 overflow-y-auto flex flex-col bg-[#070D1A]">
                <AICoach messages={coachMessages} input={coachInput} onInput={setCoachInput} onSend={sendCoach} isLoading={isLoadingAI} onClear={clearCoachHistory} />
                <LiveInsights atsScore={atsScore} skills={skills} />
              </div>
            </motion.div>
...
function Toolbar({
  ...
  return (
    <header className="min-h-16 h-auto flex-shrink-0 bg-[#070D1A]/95 backdrop-blur-xl border-b border-white/[0.07] flex flex-wrap items-center px-4 sm:px-5 gap-2 sm:gap-4 sticky top-0 z-50 py-3 md:py-0">
      ...
      <div className="flex flex-col min-w-0">
        <span className="text-white font-semibold text-xs sm:text-sm leading-none truncate">{name}</span>
        <span className="text-[#334155] text-[9px] sm:text-[10px] mt-0.5 flex items-center gap-1">
      ...
      <div className="ml-auto flex flex-wrap items-center gap-1.5 sm:gap-2">
        ...
        <button onClick={onEnhance}
          className="flex items-center gap-1.5 sm:gap-2 px-2.5 py-1.5 sm:px-4 sm:py-2 rounded-xl text-white text-xs sm:text-sm font-semibold transition-all hover:opacity-90 active:scale-95"
        ...
        <button onClick={onOpenPreview}
          className="flex items-center gap-1 px-2.5 py-1.5 sm:px-3 sm:py-2 rounded-xl text-xs sm:text-sm font-medium border border-white/10 text-[#64748B] hover:text-white hover:border-white/20 transition-all">
          <Eye className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
          <span className="hidden sm:inline">Preview</span>
        </button>

        <button onClick={onSave}
          className="flex items-center justify-center p-1.5 sm:px-3 sm:py-2 rounded-xl text-xs sm:text-sm font-medium border border-white/10 text-[#64748B] hover:text-white hover:border-white/20 transition-all">
        ...
        <div className="relative">
          <button onClick={onToggleExport}
            className="flex items-center gap-1 px-2 py-1.5 sm:px-3 sm:py-2 rounded-xl text-xs sm:text-sm font-medium border border-[#22C55E]/30 text-[#22C55E] hover:bg-[#22C55E]/10 transition-all">
...
function SectionNav({
  ...
  return (
    <nav className="w-full flex flex-col py-4 overflow-y-auto bg-[#070D1A]">
