      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 md:py-8">
        ...
        >
          <div>
            ...
            <p className="text-gray-400 text-sm md:text-lg">Manage your pharmaceutical career documents</p>
          </div>
          ...
          <div className="flex flex-wrap gap-2.5">
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="flex-1 sm:flex-initial">
              <button
                ...
                className="flex items-center justify-center gap-2 w-full px-4 py-2.5 md:px-5 md:py-3 rounded-xl text-xs md:text-sm text-gray-300 font-semibold bg-white/5 border border-white/10 hover:bg-white/10 hover:text-white transition-all hover:shadow-lg"
              >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="flex-1 sm:flex-initial">
              <button
                ...
                className="flex items-center justify-center gap-2 w-full px-4 py-2.5 md:px-5 md:py-3 rounded-xl text-xs md:text-sm text-[#22C55E] font-semibold bg-[#22C55E]/10 border border-[#22C55E]/30 hover:bg-[#22C55E]/20 transition-all hover:shadow-lg hover:shadow-[#22C55E]/15"
              >
                <Brain className="w-4 h-4 md:w-5 md:h-5 text-[#22C55E] animate-pulse" />
                Start with AI
              </button>
            </motion.div>
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="w-full sm:w-auto">
              <button
                onClick={onCreateCV}
                className="flex items-center justify-center gap-2 w-full px-4 py-2.5 md:px-5 md:py-3 rounded-xl text-xs md:text-sm text-white font-semibold bg-gradient-to-r from-[#1E3A8A] to-[#22C55E] hover:shadow-lg hover:shadow-[#22C55E]/30 transition-all border border-white/10"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="p-4 sm:p-6 md:p-8 rounded-2xl bg-gradient-to-br from-[#111827]/90 to-[#1E3A8A]/20 backdrop-blur-xl border border-white/10 shadow-2xl">
                  ...
                  {cvList.map((cv, idx) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className="group relative p-4 sm:p-5 rounded-xl bg-gradient-to-r from-[#111827]/60 to-[#111827]/40 border border-white/5 hover:border-white/20 cursor-pointer transition-all shadow-lg hover:shadow-xl overflow-hidden"
                      ...
                      >
                        ...
                        <div className="relative flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                          <div className="flex items-center gap-3 md:gap-4 flex-1">
                            <div className="w-12 h-12 md:w-14 md:h-14 rounded-xl bg-gradient-to-br from-[#1E3A8A] to-[#22C55E] flex items-center justify-center shadow-lg group-hover:shadow-[#22C55E]/30 transition-shadow flex-shrink-0">
                              <FileText className="w-6 h-6 md:w-7 md:h-7 text-white" />
                            </div>

                            <div className="flex-1 min-w-0">
                              <h3 className="font-bold text-white mb-1.5 text-base md:text-lg group-hover:text-[#22C55E] transition-colors truncate">
                                {cv.name}
                              </h3>
                              <div className="flex flex-wrap items-center gap-2 md:gap-4 text-xs md:text-sm text-gray-400">
                                <div className="flex items-center gap-1.5 px-2 py-0.5 rounded-lg bg-white/5">
                          ...
                          <div className="flex items-center justify-between sm:justify-end gap-4 w-full sm:w-auto border-t border-white/5 sm:border-t-0 pt-3 sm:pt-0">
                            <div className="text-left sm:text-right px-3 py-1.5 md:px-4 md:py-2 rounded-xl bg-gradient-to-br from-[#22C55E]/10 to-[#22C55E]/5 border border-[#22C55E]/20 flex items-center sm:block gap-2 sm:gap-0">
                              <div className="text-[10px] text-gray-400 md:mb-1 font-medium">ATS Score</div>
                              <div className="text-xl md:text-3xl font-bold text-[#22C55E]">{lastScore}%</div>
                            </div>

                            <button
                              onClick={(e) => handleMenuOpen(e, cv.id)}
                              className="p-2 rounded-lg text-gray-400 hover:text-white hover:bg-white/10 transition-all ml-auto sm:ml-0"
                            >
